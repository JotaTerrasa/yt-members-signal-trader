...
El frontend resume esta situación inmediatamente debajo de las fuentes de PnL. El bloque `Estado de alineación` muestra filas emparejadas, ausencias, entradas y salidas por encima del 0,15% adverso, costes acumulados y neto de BingX. Cuando la hoja está retrasada, lo indica antes de comparar resultados y separa las operaciones VST que todavía quedan fuera de cobertura. Es una lectura informativa y no activa filtros ni cambia la ejecución.
