...
La etiqueta `Ganancia absorbida por costes` describe el cambio de signo, no atribuye a los costes toda la distancia frente a la hoja. En esos seis pares, la brecha neta es **-39,9812 VST**: **-32,7866 VST** ya proceden de la diferencia bruta y **-7,1946 VST** de costes. Los costes son los que cruzan el resultado de positivo a negativo, pero solo explican el **18,0%** de la brecha económica de esa categoría.
