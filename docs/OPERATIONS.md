...
- Plotly no forma parte de la carga inicial de Posts o Eventos. La primera gráfica de Rendimiento activa un cargador único con CDN principal y respaldo; las peticiones simultáneas comparten la misma promesa y no insertan scripts duplicados.
