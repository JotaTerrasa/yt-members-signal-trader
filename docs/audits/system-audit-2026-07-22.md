...
- **INFO · sheet_reference_stale:** 9 aperturas VST son posteriores al último día disponible en la hoja (cobertura hasta 2026-07-20T23:59:59.999Z). No se clasifican como extras mientras falte esa referencia.
...
- **INFO · cohort_reference_partial:** 32/43 cierres actuales tienen referencia en la hoja.
- **INFO · cohort_effect_inconclusive:** El intervalo exploratorio del cambio neto va de -4.3846 a 4.2405 VST por cierre y cruza cero.
...
- Aperturas VST posteriores sin referencia: 9
...
- Fuentes de entrada: {"exchange_fill":170,"unavailable":21}
- Fuentes de salida: {"exchange_order_history":169,"unavailable":22}
...
- Posteriores sin hoja (9 operaciones): -33.8067 VST
...
- Filas comparables / VST posteriores sin referencia: 38 / 9
- Última operación disponible en la hoja: 2026-07-20T12:00:00.000Z
...
- Clasificación: {"Entrada desviada":13,"Fees dominan":3,"Stop alineado":2,"Stop con deslizamiento":3,"Diferencia de ejecución":6,"Signo distinto de mercado":2,"Alineada":3,"No ejecutada en VST":3,"Extra en VST":3,"Fuera de cobertura de la hoja":9}

## Contraste antes y después

- Estado: Cobertura parcial. 32/43 cierres actuales tienen referencia en la hoja.
- Antes: 34 cierres; 34/34 con referencia; 100.00% con precio ejecutado exacto.
- Ahora: 43 cierres; 32/43 con referencia; 100.00% con precio ejecutado exacto.
...
- Alineación: cobertura parcial. 32/43 cierres comparables con la hoja.
...
- Cobertura de la hoja: antes 100.00%; ahora 74.42%; cambio -25.58 pp; cobertura parcial.
- Gap por operación comparable: antes -4.9771 VST; ahora -2.1007 VST; cambio +2.8764 VST; cobertura parcial.
- Impacto de entrada por comparable: antes -1.4257 VST; ahora -2.3748 VST; cambio -0.9491 VST; cobertura parcial.
- Impacto de salida por comparable: antes -3.5547 VST; ahora 0.2745 VST; cambio +3.8291 VST; cobertura parcial.
...
- Bootstrap determinista (4000 iteraciones): intervalo del 95% -4.3846 a 4.2405 VST; probabilidad exploratoria de mejora 48.60%; lectura inconclusa.
