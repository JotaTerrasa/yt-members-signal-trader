...
Generada: 2026-07-25T07:31:46.542Z
Mes auditado: 2026-07
Ventana: 2026-07-01T10:55:57.218Z a 2026-07-25T07:31:46.943Z
...
- **HIGH · cohort_net_per_close_negative:** La economía de la cohorte actual sigue siendo negativa: -3,5214 VST netos por cierre; contraste inconcluso.
- **INFO · cohort_reference_partial:** 41/53 cierres actuales tienen referencia en la hoja.
- **INFO · cohort_effect_inconclusive:** El intervalo exploratorio del cambio neto va de -5.6350 a 2.6500 VST por cierre y cruza cero.
...
- Cierres medibles: 116
- Cierres por encima del 0,15%: 53
- Arrastre neto estimado en cierres: 180.5190 VST
...
- PnL bruto BingX: -159.3441 VST
- Comisiones: -192.3634 VST
- Funding: -5.4884 VST
- Neto observado: -357.1959 VST
- Devolución acreditada por BingX: 0.0000 VST (no detectada)
- Tarifa taker observada: 0.05%
- Tarifa maker observada: 0.02%
- Devolución estimada (22%): 42.3199 VST
- Neto hipotético tras devolución estimada: -314.8760 VST
- Ciclos con entradas agregadas: 10 (16 filas)
- Histórico exacto de órdenes: disponible
- Órdenes históricas leídas: 489
- Cierres con fill exacto: 179 de 179
- Órdenes de cierre / posiciones reconstruidas: 175 / 170
...
- Ejecuciones de salida > 0,15%: 53 de 116
- Fuentes de entrada: {"exchange_fill":181,"unavailable":18}
- Fuentes de salida: {"exchange_order_history":179,"unavailable":20}
...
- Posteriores sin hoja (6 operaciones): -0.3941 VST
- Extras en cobertura (10 operaciones): -64.3186 VST
- Comisiones: -192.3634 VST
- Funding: -5.4884 VST
- Bruto BingX reconstruido: -159.3441 VST
- Neto BingX reconstruido: -357.1959 VST
...
- Muestra: Muestra preliminar (53 cierres)
- Aperturas / cierres: 55 / 53
- Filas comparables / VST posteriores sin referencia: 49 / 6
- Última operación disponible en la hoja: 2026-07-23T12:00:00.000Z
- Última jornada provisional / filas abiertas: no / 0
- Neto observado: -186.6320 VST
- Comisiones: -60.6655 VST
...
- Estado: Cobertura parcial. 41/53 cierres actuales tienen referencia en la hoja.
- Antes: 34 cierres; 34/34 con referencia; 100.00% con precio ejecutado exacto.
- Ahora: 53 cierres; 41/53 con referencia; 100.00% con precio ejecutado exacto.
...
- Cierres: mejora. Media adversa 0,1157%; p95 2,36 s.
- Economía: negativo. -3,5214 VST netos por cierre; contraste inconcluso.
- Alineación: cobertura parcial. 41/53 cierres comparables con la hoja.
...
- Cierres sobre 0,15%: antes 57.14%; ahora 32.35%; cambio -24.79 pp; mejora.
...
- Coste por cierre: antes 1.1878 VST; ahora 1.1773 VST; cambio -0.0105 VST; estable.
- Bruto por cierre: antes -0.8608 VST; ahora -2.3441 VST; cambio -1.4833 VST; empeora.
- Neto por cierre: antes -2.0485 VST; ahora -3.5214 VST; cambio -1.4728 VST; empeora.
- Cobertura de la hoja: antes 100.00%; ahora 77.36%; cambio -22.64 pp; cobertura parcial.
...
- Cobertura bid/ask prospectiva: 6/34 cierres; 0 instantáneas caducadas.
- Spread medio observado: 0.01%; último precio a ejecutable 0.00%; ejecutable a fill 0.08%.
- RTT local medio: ticker 192 ms; orden 274 ms; antigüedad mediana de la cotización 69 ms.
- Reloj de bookTicker: 6/6 con marca BingX; BingX a recepción local -488 ms de mediana; recepción local a envío 69 ms; 6 con desfase aparente.
- BTC-USDT: 2/12 cierres medidos; ejecutable a fill 0.00%; 0 sobre 0,15%.
- SOL-USDT: 2/11 cierres medidos; ejecutable a fill 0.11%; 0 sobre 0,15%.
- ETH-USDT: 2/9 cierres medidos; ejecutable a fill 0.12%; 0 sobre 0,15%.
- Media neta enlazada: antes -2.0307 VST; ahora -3.4971 VST; diferencia -1.4663 VST por cierre.
- Bootstrap determinista (4000 iteraciones): intervalo del 95% -5.6350 a 2.6500 VST; probabilidad exploratoria de mejora 25.73%; lectura inconclusa.
...
- Reloj REST BingX: +967 ms de offset; RTT 182 ms; antigüedad 12.8 s; warn; solo observación
