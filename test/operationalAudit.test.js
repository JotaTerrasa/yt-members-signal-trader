...
test('cuantifica el impacto neto de cada causa y activo sobre la misma muestra', () => {
  ...
  assert.deepEqual({
    ...
    grossGapVsReplica: impact.grossGapVsReplica,
    costs: impact.costs,
    costShareOfGapPercent: impact.costShareOfGapPercent,
    ...
    replicaPnl: 2,
    bingxGross: -1.1,
    grossGapVsReplica: -3.1,
    costs: -2.9,
    costShareOfGapPercent: 48.33333333,
    bingxNet: -4,
    gapVsReplica: -6,
    residual: 0,
    reconciled: true
  ...
  assert.deepEqual(impact.groups, [
    {
      ...
      funding: -0.1,
      costs: -0.3,
      costShareOfGapPercent: 9.09090909,
      bingxNet: -1.3,
      gapVsReplica: -3.3,
    ...
    },
    {
      ...
      replicaPnl: -3,
      bingxGross: -1.1,
      grossGapVsReplica: 1.9,
      fees: -1.4,
      funding: 0,
      costs: -1.4,
      costShareOfGapPercent: null,
      bingxNet: -2.5,
      gapVsReplica: 0.5,
  ...
  assert.deepEqual(impact.bySymbol.map((group) => ({
    ...
    grossGapVsReplica: group.grossGapVsReplica,
    costs: group.costs,
    costShareOfGapPercent: group.costShareOfGapPercent,
    bingxNet: group.bingxNet,
    gapVsReplica: group.gapVsReplica
  })), [
    { key: 'BTC-USDT', rows: 2, netMismatch: 2, replicaPnl: 5, grossGapVsReplica: -5, costs: -1.5, costShareOfGapPercent: 23.07692308, bingxNet: -1.5, gapVsReplica: -6.5 },
    { key: 'SOL-USDT', rows: 2, netMismatch: 0, replicaPnl: -3, grossGapVsReplica: 1.9, costs: -1.4, costShareOfGapPercent: null, bingxNet: -2.5, gapVsReplica: 0.5 }
  ]);
});
