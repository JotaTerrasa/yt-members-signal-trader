...
- Resume al principio de la auditoría la brecha entre réplica teórica y BingX neto. Separa ejecución emparejada, comisiones/funding y cobertura/ausencias, identifica el tramo individual de mayor arrastre y permite alternar entre `Cohorte vigente` y `Mes completo`. La cohorte es el ámbito inicial cuando está disponible, para no atribuir al comportamiento actual incidencias históricas ya corregidas.
