...
- Permite recorrer la extensa vista de Rendimiento mediante un navegador fijo con siete destinos: resumen, fiabilidad, guardia, posiciones, hoja propia, rendimiento y auditoría. La sección activa sigue el desplazamiento, el destino recibe foco al activarlo con teclado y la banda se desplaza horizontalmente en móvil sin ensanchar la página. `Saltar al contenido` transfiere igualmente el foco al área principal.
